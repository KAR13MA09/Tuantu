...
<?php 
$TuantuHeader = new TuantuHeader();
$TuantuLoveDays = new TuantuLoveDays();
$TuantuMusicList = new TuantuMusicList();
$TuantuHeader->CommonMethod();
$TuantuLoveDays->CommonMethod();
$TuantuMusicList->CommonMethod();
?>
<!DOCTYPE html>
...
<head>
    ...
    <meta name="description" content="<?=$TuantuHeader->description?>">
    <meta name="author" content="ThanhDieuTV">
    <meta name="keywords"
        content="<?=$TuantuHeader->keywords?>">
    <meta name="robots" content="index, follow">
    <meta property="og:type" content="website">
    <link rel="shortcut icon" href="<?=$TuantuHeader->favicon?>?v=<?=rand(1,999)?>" type="image/x-icon">
    <meta property="og:title" content="<?=$TuantuHeader->title?>">
    <meta property="og:url" content="//thanhdieu.com">
    <meta property="og:image" content="./res/v5/img/bg3.webp">
    <title><?=$TuantuHeader->title?></title>
    <!--/ @StyleSheets /-->
...
<body class="BodyStyle">
        ...
        <section class="td-welcome">
            ...
            <div class="infos">
                <div class="logo-web-title">
                    <img class="logo-ws" src="https://i.ibb.co/MnGbYYp/447785563-332059613249421-2494227581777528195-n.jpg" alt="Nguyễn Trịnh Tuấn Tú">
    ...
    <div id="loading-box">
        <div class="loading-bg">
            <img class="loading-img entered loading" src="<?=$TuantuHeader->favicon?>?v=<?=rand(1,999)?>" data-ws-status="loading">
    ...
    <main id="td-main">
        ...
        <header id="header">
            <h2>
                <a href="#" class="site-icon"><?=$TuantuHeader->namesite?></a>
            </h2>
        ...
        <section class="td-content">
            <div class="about-me">
                <div class="info-left">
                    <span class="tag"><?=$TuantuHeader->bio1?></span>
                    <span class="tag"><?=$TuantuHeader->bio2?></span>
                    <span class="tag"><?=$TuantuHeader->bio3?></span>
                </div>
                <div class="avatar">
                    <img class="avatar-img" src="<?=$TuantuHeader->avatar?>?v=<?=rand(1,999)?>" alt="Nguyễn Trịnh Tuấn Tú">
                    <img class="crown" src="./res/v5/img/crown/mong-vuot-rong.png">
                    <!-- <img class="crown2" src="./res/v5/img/crown/vip-crown.png"> -->
                </div>
                <div class="info-right">
                    <span class="tag"><?=$TuantuHeader->bio4?></span>
                    <span class="tag"><?=$TuantuHeader->bio5?></span>
                    <span class="tag"><?=$TuantuHeader->bio6?></span>
                </div>
            </div>
            <div class="padding" style="height:2em;"></div>
            <h2 class="HoVaTen__">
                <span id="userName" data-userName='<?= json_encode($TuantuHeader->userName ?? []) ?>'></span>
            </h2>
            <div class="about-me-2">
                <button class="trigger"><?=$TuantuHeader->trigger?></button>
                <button class="trigger"><?=$TuantuHeader->bio1?></button>
                <button class="trigger"><?=$TuantuHeader->bio2?></button>
                <button class="trigger"><?=$TuantuHeader->bio3?></button>
                <button class="trigger"><?=$TuantuHeader->bio4?></button>
                <button class="trigger"><?=$TuantuHeader->bio5?></button>
                <button class="trigger"><?=$TuantuHeader->bio6?></button>
            </div>
            <div class="padding" style="height:1em;"></div>
            <section id="hr-mod">
                <?php foreach ($TuantuHeader->SocialNetworks as $network => $url): ?>
    ...
    <div class="padding" style="height:4em;"></div>
        <div class="love-time1 mt-5">
            <div class="hide" data-ngayyeu="<?= $TuantuLoveDays->ConfigLove['time_relashiption']; ?>"></div>
        ...
        <div class="bg-wrap central mt-5">
            <div class="bg-img">
                <div class="middle animated">
                    <div class="img-male">
                        <img src="<?=$TuantuLoveDays->ConfigLove['avatar_male'];?>"
                            alt="<?=$TuantuLoveDays->ConfigLove['name_male'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$TuantuLoveDays->ConfigLove['name_male'];?></span>
                    </div>
                    <div class="heart"></div>
                    <div class="img-female">
                        <img src="<?=$TuantuLoveDays->ConfigLove['avatar_female'];?>"
                            alt="<?=$TuantuLoveDays->ConfigLove['name_female'];?>">
                        <img class="crown-love" src="./res/v5/img/crown/khung-4.png">
                        <span><?=$TuantuLoveDays->ConfigLove['name_female'];?></span>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="nk-opt-set nk-opt-set-aside-apps change-bg">
                                    ...
                                    <div class="nk-opt-list col-4x">
                                        ...
                                        <div class="nk-opt-item"
                                            data-bg="https://i.ibb.co/61Skw7G/Tuantu.webp">
                                            <span class="nk-opt-item-bg">
                            ...
                            <div class="nk-opt-set">
                                ...
                                <div class="nk-opt-list">
                                    <ul class="music_menu_list">
                                        <?php foreach ($TuantuMusicList->songs as $song): ?>
                                        <li url="<?= $song['url'] ?>">
                                            <span class="name">
    ...
    <footer id="footer">
        <span>
            <a href="//Tuantu.com" target="_blank">&copy; Copyright&nbsp;Tuantu 2024</a>
        </span>
    </footer>
    ...
    <script src="//cdn.Tuantu.com/dialog/wstoast/ws.toast.js"></script>
